# CodeAlpha Social Media Platform — Project Rules
...
* **Self-Contained Storage**: The SQLite database (`social.db`) and uploaded media must live within this project folder (`server/data/` or `server/database/`).
...
## 3. UI/UX Standards
* Modern social media timeline experience (inspired by Twitter/Bluesky) with card feeds, micro-interactions, and instant feedback.
* Optimistic UI updates for likes and follows for immediate visual responsiveness.
* Clear feedback for user actions: loading spinners, toast notifications, empty feed states, and modal overlays.
